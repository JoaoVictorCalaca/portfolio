...
function Repositories() {
  ...
  return (
    <div className='flex flex-wrap gap-4'>
      {repos.map((repo) => (
        <div key={repo.id} className="hover:p-3 sm:w-fit w-full h-fit sm:max-w-1/2 border-gray-200 hover:bg-gray-800 cursor-pointer rounded-md text-gray-100 duration-300 flex flex-col justify-start gap-3">
